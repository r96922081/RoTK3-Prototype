...
namespace UiEditor
{
    public partial class UiEditorWindow : Window
    {
        private void add_event_handler()
        {
            ...
            rectangle_toggle_button.Click += Rectangle_toggle_button_Click;
        ...
        private void LoadSavedFile(string file_path)
        {
            using (StreamReader reader = new StreamReader(file_path))
            {
                ...
                for (int i = 0; i < save_data.UiEditorRects.Count; i++)
                {
                    UiEditorRect d = save_data.UiEditorRects[i];
                    RectangleDrawable t = new RectangleDrawable(d.GetWpfUiElement());
        ...
        private void Rectangle_toggle_button_Click(object sender, RoutedEventArgs e)
        {
